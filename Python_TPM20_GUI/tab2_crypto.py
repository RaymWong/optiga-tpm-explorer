...
class Tab_RSA(wx.Panel):
    def __init__(self, parent):
        ...
        input_sizer.Add(inputtext, 1, wx.ALIGN_CENTRE, 5)
        input_sizer.Add(self.input_display, 11, wx.ALIGN_CENTRE, 0)
...
class Tab2Frame(wx.Frame):
    def __init__(self, parent, title):
        ...
        self.Centre(wx.BOTH)
        main_menu_font = wx.Font(12, wx.FONTFAMILY_SWISS, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL)
