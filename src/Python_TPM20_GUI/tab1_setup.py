...
class Tab_Setup(wx.Panel):
    def __init__(self, parent):
        ...
        button_disablelock.SetToolTip(wx.ToolTip("TPM2_ClearControl: Disable the use of TPM2_Clear"))
        button_enablelock.SetToolTip(wx.ToolTip("TPM2_ClearControl: Enable the use of TPM2_Clear"))
